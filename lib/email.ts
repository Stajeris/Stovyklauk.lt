...
/**
 * Sends a reservation confirmation email to the guest using Resend library.
 */
...
/**
 * Server Action handler for sending booking confirmation email
 */
export async function sendConfirmationEmailServerAction(payload: BookingConfirmationEmailParams) {
  return await sendBookingConfirmationEmail(payload);
}
